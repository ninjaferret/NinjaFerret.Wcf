...
{
    public class ServiceTypeNotAnInterfaceException : InvalidServiceTypeException
    {
        public ServiceTypeNotAnInterfaceException(Type type)
            : base (type, string.Format("Type {0} is not an interface", type.FullName))
        {
        }
    }
}
