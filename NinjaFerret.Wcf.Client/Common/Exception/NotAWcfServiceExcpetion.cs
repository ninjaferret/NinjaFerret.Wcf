...
{
    public class NotAWcfServiceExcpetion : System.Exception
    {
        public Type ServiceType { get; private set; }

        public NotAWcfServiceExcpetion(Type serviceType)
            : base(string.Format("{0} is not a WCF Service", serviceType))
        {
