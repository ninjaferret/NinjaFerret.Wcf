...
{
    public  class NotAnInterfaceExcpetion : System.Exception
    {
        public Type ServiceType { get; private set; }

        public NotAnInterfaceExcpetion(Type serviceType)
            : base(string.Format("{0} must be an interface", serviceType))
        {
