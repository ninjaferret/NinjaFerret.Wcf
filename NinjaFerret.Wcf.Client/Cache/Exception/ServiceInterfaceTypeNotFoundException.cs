...
{
    public class ServiceInterfaceTypeNotFoundException : System.Exception
    {
        public Type ServiceType { get; set; }

        public ServiceInterfaceTypeNotFoundException(Type serviceType)
            : base (string.Format("{0} cannot be found", serviceType))
        {
